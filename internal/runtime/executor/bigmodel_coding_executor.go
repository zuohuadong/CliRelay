...
func (e *BigModelCodingExecutor) injectOfficialMCPTools(payload []byte, model, apiKey string) ([]byte, error) {
	...
	for _, spec := range []struct {
		...
		{label: "web-search-prime", url: "https://api.z.ai/api/mcp/web_search_prime/mcp"},
		{label: "web-reader", url: "https://api.z.ai/api/mcp/web_reader/mcp"},
	} {
