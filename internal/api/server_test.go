...
func TestManagementPanelDataRoutesRegistered(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{method: http.MethodGet, endpoint: "/v0/management/model-path-availability", wantCode: http.StatusOK},
		{method: http.MethodGet, endpoint: "/v0/management/identity-fingerprint", wantCode: http.StatusOK},
		{method: http.MethodGet, endpoint: "/v0/management/usage/logs?page=1&size=50&days=7", wantCode: http.StatusOK},
		{method: http.MethodGet, endpoint: "/v0/management/usage/logs/1/content?part=input", wantCode: http.StatusOK},
		{method: http.MethodGet, endpoint: "/v0/management/usage/export", wantCode: http.StatusOK},
		{method: http.MethodPost, endpoint: "/v0/management/usage/import", body: `{}`, wantCode: http.StatusOK},
		...
		{method: http.MethodGet, endpoint: "/v0/management/api-key-entries", wantCode: http.StatusOK},
		{method: http.MethodGet, endpoint: "/v0/management/channel-groups", wantCode: http.StatusOK},
		{method: http.MethodGet, endpoint: "/v0/management/astron-code-api-key", wantCode: http.StatusOK},
		{method: http.MethodGet, endpoint: "/v0/management/bedrock-api-key", wantCode: http.StatusOK},
		{method: http.MethodGet, endpoint: "/v0/management/ampcode", wantCode: http.StatusOK},
		{method: http.MethodGet, endpoint: "/v0/management/ampcode/model-mappings", wantCode: http.StatusOK},
		{method: http.MethodGet, endpoint: "/v0/management/agnes-api-key", wantCode: http.StatusOK},
		{method: http.MethodGet, endpoint: "/v0/management/bigmodel-coding-api-key", wantCode: http.StatusOK},
		{method: http.MethodGet, endpoint: "/v0/management/opencode-go-api-key", wantCode: http.StatusOK},
		{method: http.MethodDelete, endpoint: "/v0/management/agnes-api-key", wantCode: http.StatusBadRequest},
		{method: http.MethodDelete, endpoint: "/v0/management/bigmodel-coding-api-key", wantCode: http.StatusBadRequest},
		{method: http.MethodDelete, endpoint: "/v0/management/opencode-go-api-key", wantCode: http.StatusBadRequest},
		{method: http.MethodGet, endpoint: "/v0/management/model-prices", wantCode: http.StatusOK},
