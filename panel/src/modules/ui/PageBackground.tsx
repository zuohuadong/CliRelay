  ...
  return (
    <div className="relative min-h-[100dvh] overflow-hidden bg-zinc-50 font-sans text-slate-900 antialiased dark:bg-neutral-950 dark:text-slate-50">
      <div className="pointer-events-none absolute inset-0">
        ...
        {variant === "login" ? (
          <div className="absolute inset-x-0 top-1/2 h-80 -translate-y-1/2 bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.5),transparent)] blur-3xl dark:bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.07),transparent)]" />
        ) : null}
      </div>
