...
type Config struct {
	...
	// gemini-api-key, interactions-api-key, codex-api-key, xai-api-key, claude-api-key,
	// openai-compatibility, vertex-api-key, and ampcode.
...
const (
	DefaultCodexFingerprintUserAgent     = "codex-tui/0.146.1 (Mac OS 26.5.0; arm64) iTerm.app/3.6.10 (codex-tui; 0.146.1)"
	DefaultCodexFingerprintVersion       = "0.146.1"
