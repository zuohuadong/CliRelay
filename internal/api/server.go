...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/model-overrides", s.mgmt.GetModelOverrides)
		mgmt.PUT("/model-overrides", s.mgmt.PutModelOverrides)
...
// UpdateClientsContext updates runtime clients while honoring cancellation
// between configuration, plugin, and filesystem operations.
