...
var officialModelPrices = []ModelPriceRow{
	...
	{Model: "gpt-5.6-luna", Mode: "token", InputPricePerM: 0.2, OutputPricePerM: 1.2, CachedPricePerM: 0.02},
	{Model: "gpt-5.4", Mode: "token", InputPricePerM: 2.5, OutputPricePerM: 15, CachedPricePerM: 0.25},
	{Model: "gpt-5.4-mini", Mode: "token", InputPricePerM: 0.75, OutputPricePerM: 4.5, CachedPricePerM: 0.075},
	{Model: "gpt-5.3-codex", Mode: "token", InputPricePerM: 1.75, OutputPricePerM: 14, CachedPricePerM: 0.175},
	{Model: "gpt-5.3-codex-spark", Mode: "token", InputPricePerM: 1.75, OutputPricePerM: 14, CachedPricePerM: 0.175},
	{Model: "gpt-5.2", Mode: "token", InputPricePerM: 1.75, OutputPricePerM: 14, CachedPricePerM: 0.175},
	...
	{Model: "gpt-4.1", Mode: "token", InputPricePerM: 2, OutputPricePerM: 8, CachedPricePerM: 0.5},
	...
	{Model: "claude-opus-4-7", Mode: "token", InputPricePerM: 5, OutputPricePerM: 25, CachedPricePerM: 0.5},
	{Model: "claude-opus-4-6", Mode: "token", InputPricePerM: 5, OutputPricePerM: 25, CachedPricePerM: 0.5},
	...
	{Model: "claude-opus-4-6-thinking", Mode: "token", InputPricePerM: 5, OutputPricePerM: 25, CachedPricePerM: 0.5},
	{Model: "claude-sonnet-5", Mode: "token", InputPricePerM: 2, OutputPricePerM: 10, CachedPricePerM: 0.2},
	{Model: "claude-sonnet-4-6", Mode: "token", InputPricePerM: 3, OutputPricePerM: 15, CachedPricePerM: 0.3},
	{Model: "claude-sonnet-4-5", Mode: "token", InputPricePerM: 3, OutputPricePerM: 15, CachedPricePerM: 0.3},
	...
	{Model: "claude-haiku-4-5", Mode: "token", InputPricePerM: 1, OutputPricePerM: 5, CachedPricePerM: 0.1},
	{Model: "claude-haiku-4-5-20251001", Mode: "token", InputPricePerM: 1, OutputPricePerM: 5, CachedPricePerM: 0.1},
	...
	{Model: "gemini-3-pro-preview", Mode: "token", InputPricePerM: 2, OutputPricePerM: 12, CachedPricePerM: 0.2},
	{Model: "gemini-3-pro", Mode: "token", InputPricePerM: 2, OutputPricePerM: 12, CachedPricePerM: 0.2},
	{Model: "gemini-3-pro-high", Mode: "token", InputPricePerM: 2, OutputPricePerM: 12, CachedPricePerM: 0.2},
	{Model: "gemini-3-pro-low", Mode: "token", InputPricePerM: 2, OutputPricePerM: 12, CachedPricePerM: 0.2},
	{Model: "gemini-3.1-pro", Mode: "token", InputPricePerM: 2, OutputPricePerM: 12, CachedPricePerM: 0.2},
	...
	{Model: "grok-4.20-0309-reasoning", Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 2.5, CachedPricePerM: 0.2},
	{Model: "grok-4.20-0309-non-reasoning", Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 2.5, CachedPricePerM: 0.2},
	{Model: "grok-4.20-multi-agent-0309", Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 2.5, CachedPricePerM: 0.2},
	...
	{Model: "grok-build-0.1", Mode: "token", InputPricePerM: 1, OutputPricePerM: 2, CachedPricePerM: 0.2},
	...
	{Model: "imagen-3.0-fast-generate-001", Mode: "call", PricePerCall: 0.02},
	{Model: "imagen-4.0-generate-001", Mode: "call", PricePerCall: 0.04},
	{Model: "imagen-4.0-ultra-generate-001", Mode: "call", PricePerCall: 0.06},
	{Model: "imagen-4.0-fast-generate-001", Mode: "call", PricePerCall: 0.02},
	...
	{Model: "gemini-pro-agent", Mode: "token", InputPricePerM: 2, OutputPricePerM: 12, CachedPricePerM: 0.2},
...
// the model_prices table if they are not already present. It also upgrades rows
// that still exactly match the prior built-in price, while preserving operator
// edits and locked rows. Runs at most once per process.
...
// isPreviousOfficialSeedPrice identifies only values emitted by the previous
...
var previousOfficialModelPrices = map[string]ModelPriceRow{
	...
	"gpt-5.4":                        {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.125},
	"gpt-5.4-mini":                   {Mode: "token", InputPricePerM: 0.25, OutputPricePerM: 2, CachedPricePerM: 0.025},
	"gpt-5.3-codex":                  {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.125},
	"gpt-5.3-codex-spark":            {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.125},
	"gpt-5.2":                        {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.125},
	"gpt-4.1":                        {Mode: "token", InputPricePerM: 2.5, OutputPricePerM: 10, CachedPricePerM: 0.625},
	"claude-fable-5":                 {Mode: "token", InputPricePerM: 5, OutputPricePerM: 25, CachedPricePerM: 0.5},
	"claude-haiku-4-5-20251001":      {Mode: "token", InputPricePerM: 0.8, OutputPricePerM: 4, CachedPricePerM: 0.08},
	"claude-opus-4-6":                {Mode: "token", InputPricePerM: 15, OutputPricePerM: 75, CachedPricePerM: 1.5},
	"claude-opus-4-6-thinking":       {Mode: "token", InputPricePerM: 15, OutputPricePerM: 75, CachedPricePerM: 1.5},
	"claude-opus-4-7":                {Mode: "token", InputPricePerM: 15, OutputPricePerM: 75, CachedPricePerM: 1.5},
	"claude-opus-4-8":                {Mode: "token", InputPricePerM: 15, OutputPricePerM: 75, CachedPricePerM: 1.5},
	"gemini-3-pro-preview":           {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.3125},
	"gemini-3-pro":                   {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.3125},
	"gemini-3-pro-high":              {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.3125},
	"gemini-3-pro-low":               {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.3125},
	"gemini-3.1-pro":                 {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.3125},
	"gemini-3.1-pro-preview":         {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.3125},
	"gemini-3.1-pro-high":            {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.3125},
	"gemini-3.1-pro-low":             {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.3125},
	"gemini-3-flash-preview":         {Mode: "token", InputPricePerM: 0.15, OutputPricePerM: 0.6, CachedPricePerM: 0.0375},
	"gemini-3-flash":                 {Mode: "token", InputPricePerM: 0.15, OutputPricePerM: 0.6, CachedPricePerM: 0.0375},
	"gemini-3-flash-agent":           {Mode: "token", InputPricePerM: 0.15, OutputPricePerM: 0.6, CachedPricePerM: 0.0375},
	"gemini-3.1-flash-lite-preview":  {Mode: "token", InputPricePerM: 0.075, OutputPricePerM: 0.3, CachedPricePerM: 0.01875},
	"gemini-3.1-flash-lite":          {Mode: "token", InputPricePerM: 0.075, OutputPricePerM: 0.3, CachedPricePerM: 0.01875},
	"gemini-3-pro-image-preview":     {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.3125},
	"gemini-3.1-flash-image-preview": {Mode: "token", InputPricePerM: 0.35, OutputPricePerM: 1.05, CachedPricePerM: 0.0875},
	"gemini-3.5-flash":               {Mode: "token", InputPricePerM: 0.15, OutputPricePerM: 0.6, CachedPricePerM: 0.0375},
	"gemini-3.5-flash-extra-low":     {Mode: "token", InputPricePerM: 0.15, OutputPricePerM: 0.6, CachedPricePerM: 0.0375},
	"gemini-3.5-flash-low":           {Mode: "token", InputPricePerM: 0.15, OutputPricePerM: 0.6, CachedPricePerM: 0.0375},
	"gemini-2.5-flash":               {Mode: "token", InputPricePerM: 0.15, OutputPricePerM: 0.6, CachedPricePerM: 0.0375},
	"gemini-2.5-flash-lite":          {Mode: "token", InputPricePerM: 0.075, OutputPricePerM: 0.3, CachedPricePerM: 0.01875},
	"gemini-flash-latest":            {Mode: "token", InputPricePerM: 0.15, OutputPricePerM: 0.6, CachedPricePerM: 0.0375},
	"gemini-flash-lite-latest":       {Mode: "token", InputPricePerM: 0.075, OutputPricePerM: 0.3, CachedPricePerM: 0.01875},
	"gemini-pro-agent":               {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.3125},
	"gemini-2.5-pro":                 {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.3125},
	"gemini-2.5-flash-image":         {Mode: "token", InputPricePerM: 0.35, OutputPricePerM: 1.05, CachedPricePerM: 0.0875},
	"gemini-pro-latest":              {Mode: "token", InputPricePerM: 1.25, OutputPricePerM: 10, CachedPricePerM: 0.3125},
	"grok-4.20-0309-non-reasoning":   {Mode: "token", InputPricePerM: 3, OutputPricePerM: 15, CachedPricePerM: 0.3},
	"grok-4.20-0309-reasoning":       {Mode: "token", InputPricePerM: 5, OutputPricePerM: 25, CachedPricePerM: 0.5},
	"grok-4.20-multi-agent-0309":     {Mode: "token", InputPricePerM: 5, OutputPricePerM: 25, CachedPricePerM: 0.5},
	"grok-4.3":                       {Mode: "token", InputPricePerM: 3, OutputPricePerM: 15, CachedPricePerM: 0.3},
	"grok-build-0.1":                 {Mode: "token", InputPricePerM: 5, OutputPricePerM: 15, CachedPricePerM: 0.5},
