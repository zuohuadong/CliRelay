...
// as of 2026-08-21. Prices use each provider's standard paid tier and short
...
var officialModelPrices = []ModelPriceRow{
	...
	// Gemini image calls use the standard 1K output-image list price.
	{Model: "gemini-3.1-flash-image", Mode: "call", PricePerCall: 0.0336},
	{Model: "gemini-3.1-flash-image-preview", Mode: "call", PricePerCall: 0.0336},
	{Model: "gemini-3-pro-image", Mode: "call", PricePerCall: 0.134},
	{Model: "gemini-3-pro-image-preview", Mode: "call", PricePerCall: 0.134},
...
var previousOfficialModelPrices = map[string]ModelPriceRow{
	...
	"gemini-3.1-flash-image":         {Mode: "call", PricePerCall: 0.00056},
