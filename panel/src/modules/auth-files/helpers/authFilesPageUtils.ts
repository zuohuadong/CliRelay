...
export const sanitizeAuthFilesForCache = (files: AuthFileItem[]): AuthFileItem[] =>
  files.map((file) => ({
    ...
    token_health: file.token_health,
    tokenHealth: file.tokenHealth,
    token_expires_at: file.token_expires_at,
    tokenExpiresAt: file.tokenExpiresAt,
    token_expires_at_ms: file.token_expires_at_ms,
    tokenExpiresAtMs: file.tokenExpiresAtMs,
    token_last_refresh: file.token_last_refresh,
    tokenLastRefresh: file.tokenLastRefresh,
    token_last_refresh_ms: file.token_last_refresh_ms,
    tokenLastRefreshMs: file.tokenLastRefreshMs,
    token_seconds_left: file.token_seconds_left,
    tokenSecondsLeft: file.tokenSecondsLeft,
    token_days_left: file.token_days_left,
    tokenDaysLeft: file.tokenDaysLeft,
